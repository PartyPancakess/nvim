...
return {
    {
        ...
        config = function()
            ...
            vim.keymap.set("n", "<leader>b<F8>", dap.continue, { desc = "Debug: Continue" })
            vim.keymap.set("n", "<leader>b<F10>", dap.step_over, { desc = "Debug: Step Over" })
            vim.keymap.set("n", "<leader>b<F11>", dap.step_into, { desc = "Debug: Step Into" })
            vim.keymap.set("n", "<leader>b<F12>", dap.step_out, { desc = "Debug: Step Out" })
...

    {
        ...
        config = function()
            ...
            vim.keymap.set("n", "<leader>bur", function() toggle_debug_ui("repl") end, { desc = "Debug: toggle repl UI" })
            vim.keymap.set("n", "<leader>bus", function() toggle_debug_ui("stacks") end,
                { desc = "Debug: toggle stacks UI" })
            vim.keymap.set("n", "<leader>buw", function() toggle_debug_ui("watches") end,
                { desc = "Debug: toggle watches UI" })
            vim.keymap.set("n", "<leader>bub", function() toggle_debug_ui("breakpoints") end,
                { desc = "Debug: toggle breakpoints UI" })
            vim.keymap.set("n", "<leader>buS", function() toggle_debug_ui("scopes") end,
                { desc = "Debug: toggle scopes UI" })
            vim.keymap.set("n", "<leader>buc", function() toggle_debug_ui("console") end,
